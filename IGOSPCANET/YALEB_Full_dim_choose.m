...
for itr_train = 1:length(t_num)
    ...
    for itr = 1:50
        ...
        tic;
        [ftrain V BlkIdx] = PCANet_train(TrnData_ImgCell,PCANet); % BlkIdx serves the purpose of learning block-wise DR projection matrix; e.g., WPCA
        PCANet_TrnTime = toc;
    ...
    save(['TestYALEB32_' int2str(train_num) '_manifold_IGOPCA_dfull_' num2str(PCANet.Lamda) '.mat'],'F_dims','F_acc','F_err','PCANet','V');
